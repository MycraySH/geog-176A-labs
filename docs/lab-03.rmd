...
ggplot()+
  ...
  geom_sf(data = eqdc_uscities, aes(col = distance_border), lty = 2, alpha = .5) + 
...
ggplot() +
  ...
  geom_sf(data = eqdc_uscities, aes(col = distance_state), lty = 2, alpha = .5) +
...
ggplot() +
  ...
  geom_sf(data = border_zone, aes(col = distance_border), size = .1) +
  geom_sf(data = borderpop) +
