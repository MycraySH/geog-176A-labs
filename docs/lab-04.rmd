...
#3.6
#The influence of the tessellated surface in the visualization of point counts
#
```
#Question 4
...
navipol = point_in_polygon(navigation,ct_grid_cv,"id")
